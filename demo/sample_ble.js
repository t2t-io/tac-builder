...
var app = {
    ...
    bleScan: function(){
        $("#ble-list").text("Start BLE scanning")
        ble.scan([], 5, app.onDiscoverDevice, app.onError);
    },

    onDiscoverDevice(device){
        $("#ble-list").append("<p>id:"+device.id+" name:"+device.name+" rssi:"+device.rssi+"</p><br>")
    },

    onError(reason){
        $("#ble-list").append("<p>"+reason)
    },
    ...
    onDeviceReady: function() {
        $(".ui-btn:contains('BLE')").click(app.bleScan)
